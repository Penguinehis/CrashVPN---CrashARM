#!/bin/bash
clear
echo -e "\033[1;32mDESEJA DESISTALAR O CrashARM MANAGER\033[1;33m"
...
if [[ "$resp" = s || "$resp" = S ]];then
    ...
    rm -rf /etc/CrashARM > /dev/null 2>&1
    clear
    echo -e "\033[1;36mObrigado por utilizar o CrashARM MANAGER\033[1;33m"
    sleep 2
