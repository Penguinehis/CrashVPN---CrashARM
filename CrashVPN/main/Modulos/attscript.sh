...
fun_atts () {
  ...
  [[ -e /tmp/att ]] && rm /tmp/att
	...
	wget -c -P /home https://github.com/Penguinehis/CrashVPN---CrashARM/raw/main//CrashVPN/main/versao
...
[[ "$vrs1" == "$vrs2" ]] && {
  ...
  if [[ "$res" = s || "$res" = S ]];then
    ...
    wget https://github.com/Penguinehis/CrashVPN---CrashARM/raw/main//CrashVPN/main/crashvpn > /dev/null 2>&1
