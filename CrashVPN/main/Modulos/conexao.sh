	...
	inst_ssl() {
		if netstat -nltp | grep 'stunnel4' 1>/dev/null 2>/dev/null; then
            ...
            [[ "$resposta" = '3' ]] && {
				...
				rm -rf cert.pem
				rm -rf key.pem
				wget https://github.com/Penguinehis/CrashVPN---CrashARM/raw/main//CrashVPN/main/stunnelcerts/cert
                wget https://github.com/Penguinehis/CrashVPN---CrashARM/raw/main//CrashVPN/main/stunnelcerts/key
				wget https://github.com/Penguinehis/CrashVPN---CrashARM/raw/main//CrashVPN/main/stunnelcerts/stunnel
				mv cert cert.pem
                mv key key.pem
...
exit 0' >$RCLOCAL
	...
	fun_socks() {
		...
		[[ $(screen -list | grep -wc 'proxy4') != '0' ]] && wssecu="\033[1;32m◉" || wssecu="\033[1;31m○"
		echo ""
		...
		echo -e "\033[1;31m[\033[1;36m4\033[1;31m] \033[1;37m• \033[1;33mWEBSOCKET SECURITY $wssecu \033[0m"
		echo -e "\033[1;31m[\033[1;36m0\033[1;31m] \033[1;37m• \033[1;33mVOLTAR\033[0m"
		echo ""
		echo -ne "\033[1;32mOQUE DESEJA FAZER \033[1;33m?\033[1;37m "
		read resposta
	...
	fun_conexao() {
		while true $x != "ok"; do
            ...
            [[ "$(netstat -tlpn | grep 'proxy' | wc -l)" != '0' ]] && {
				echo -e "\033[1;32mSERVICO: \033[1;33mWebSocket Security: \033[1;32mPORTA: \033[1;37m$(netstat -nplt | grep 'proxy' | awk {'print $4'} | xargs)"
				sts8="\033[1;32m◉ "
			} || {
				sts8="\033[1;31m○ "
			}
...
[\033[1;36m05\033[1;31m] \033[1;37m• \033[1;33mPROXY SOCKS $sts4 | Security $sts8\033[1;31m
